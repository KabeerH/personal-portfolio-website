...
addProject('Personal Portfolio Website', 'This personal portfolio website is a dynamic, interactive showcase of the skills, projects, and experiences I possess. Made with HTML, CSS, and JavaScript, it features a clean, professional design that is both responsive and user-friendly. The HTML structure provides a solid foundation, ensuring the website’s accessibility. The CSS styling brings the site to life with visually appealing layouts, colors, and animations. JavaScript adds interactivity to the site, enhancing the user experience with features like a dynamic project gallery, smooth scrolling, and a contact form with validation. This personal portfolio website shows of what I have learned and what I yet to learn in my journey as a web developer.', 'https://github.com/KabeerH/personal-portfolio-website/tree/main', './Assets/Images/website.png');
addProject('Restaurant Reservation System', 'This project is a cloud-based restaurant reservation system designed to help individuals manage, update, and cancel reservations for a restaurant system. The system allows users to create new reservations, update pre-existing reservations, and delete (cancel) reservations. Before making a reservation to their desired restaurant, users are required to register for an account. Unlike traditional restaurant reservation systems, this system asks the user to register for an account, giving the user access to multiple restaurants. This acts like a central system where the user can make a reservation to different restaurants, saving the user time as they don’t have to go to different websites for different restaurants. The system ensures a secure environment with proper security measures to ensure that no sensitive data gets leaked to anyone besides the user and the restaurant they made the reservation to The project uses a microservice architecture style approach.', 'https://github.com/KabeerH/Cloud-Based-Restaurant-Reservation-System', './Assets/Images/reservation_system.png')
